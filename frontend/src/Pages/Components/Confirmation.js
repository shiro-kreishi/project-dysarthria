import { Flex, Stack, Heading, Text, Icon, useColorModeValue, createIcon } from '@chakra-ui/react';
      ...
      <Stack
        ...
        <Stack align={'center'} spacing={2}>
          <Heading
            ...
            Вам пришло сообщение на почту
          </Heading>
          <Text fontSize={'lg'} color={'gray.500'}>
            Пожалуйста подтвердите свою почту, которую вы указали при регистрации
          </Text>
        </Stack>
      </Stack>
    </Flex>
